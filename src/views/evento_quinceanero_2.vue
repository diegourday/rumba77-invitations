<template>
  <div class="invite" v-if="event">
    <img
      ...
      class="rbimg"
      src="/img/event/evento_quinceanero_2/crown-top.svg"
    ...
    <section class="invite__header">
      <div class="invite__event-details">
        ...
        <img
          src="/img/event/evento_quinceanero_2/main-img.svg"
          :class="{ 'invite__image--main': startAnimations }"
          class="rbimg"
          alt="Imagen Quinceañera"
        />
      </div>
    </section>
    ...
    <section class="invite__countdown">
      <img
        ...
        src="/img/event/evento_quinceanero_2/rose-crown.svg"
        alt="Chat"
      />
    ...
    <section class="invite__address" v-if="event.address">
      ...
      <div class="invite__address-text">
        <span>
          <span class="material-symbols-outlined locations invite__address-icon">location_on</span>
    ...
    <section class="invite__countdown">
      <img
        ...
        src="/img/event/evento_quinceanero_2/butterfly.svg"
        alt="Regalos"
      />
    </section>

    <section class="invite__parents" v-if="event.parents == true && event.type.parents">
      <h2 class="invite__subtitle">Padres</h2>
      <div class="invite__parents-content">
        <img class="invite__parents-image" src="/img/event/evento_quinceanero_2/parents.svg" />
    ...
    <section class="invite__parents" v-if="event.godparents == true && event.type.godparents">
      ...
      <div class="invite__parents-content">
        <img class="invite__parents-image" src="/img/event/evento_quinceanero_2/godparents.svg" />
        <div class="invite__parents-wrap">
          <div
            v-for="related in event.family"
            v-show="related && related.type && related.type.name == 'Padrino'"
  ...
  methods: {
    calculateTimeLeft() {
      this.interval = setInterval(() => {
        ...
        this.minutes = String(Math.floor((difference % (1000 * 60 * 60)) / (1000 * 60))).padStart(
          2,
          '0'
        )
