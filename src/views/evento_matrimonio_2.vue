<template>
  <div class="invite" v-if="event">
    ...
    <section class="invite__countdown">
      <img class="invite__gifts-img" src="/img/event/evento_matrimonio_2/roses.svg" alt="Regalos" />
    </section>
    ...
    <section class="invite__parents" v-if="event.godparents == true && event.type.godparents">
      ...
      <div class="invite__parents-content">
        <img class="invite__parents-image" src="/img/event/evento_matrimonio_2/godparents.svg" />
